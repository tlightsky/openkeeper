...
#
# Created: Sun Oct 10 15:03:55 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.outter_ip = QtGui.QPushButton(self.outter_login)
        self.outter_ip.setEnabled(False)
        self.outter_ip.setCursor(QtCore.Qt.PointingHandCursor)
        self.outter_ip.setObjectName(_fromUtf8("outter_ip"))
        self.horizontalLayout_3.addWidget(self.outter_ip)
        self.outter_route = QtGui.QPushButton(self.outter_login)
        self.outter_route.setEnabled(False)
        self.outter_route.setCursor(QtCore.Qt.PointingHandCursor)
        self.outter_route.setObjectName(_fromUtf8("outter_route"))
        self.horizontalLayout_3.addWidget(self.outter_route)
        ...
        self.outter_textBrowser.setMaximumSize(QtCore.QSize(180, 188))
        ...
        self.horizontalLayout_4.addWidget(self.outter_login)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.outter_eth_select.setItemText(1, QtGui.QApplication.translate("MainWindow", "eth1", None, QtGui.QApplication.UnicodeUTF8))
        self.outter_eth_select.setItemText(2, QtGui.QApplication.translate("MainWindow", "wlan0", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.outter_ip.setText(QtGui.QApplication.translate("MainWindow", "外网IP", None, QtGui.QApplication.UnicodeUTF8))
        self.outter_route.setText(QtGui.QApplication.translate("MainWindow", "查看路由", None, QtGui.QApplication.UnicodeUTF8))
